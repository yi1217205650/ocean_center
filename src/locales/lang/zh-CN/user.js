export default {
  ...
  'user.login.message-invalid-credentials': '手机号或密码错误',
  'user.login.message-invalid-verification-code': '验证码错误',
  'user.login.tab-login-credentials': '手机号密码登录',
  'user.login.tab-login-mobile': '手机号验证码登录',
  'user.login.mobile.placeholder': '手机号',
  'user.login.mobile.error': '请检查手机号',
